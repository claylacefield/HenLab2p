function [all_centroid_projections_correlations,number_of_cells_per_session]=evaluate_data_quality(spatial_footprints,footprints_projections_corrected,maximal_cross_correlation,best_translations,reference_session_index,alignment_type)
...
number_of_sessions=size(footprints_projections_corrected,2);
...
if number_of_sessions>2
    ...
    for n=1:number_of_sessions
        ...
        for k=n+1:number_of_sessions
            all_centroid_projections_correlations(n,k)=corr2(footprints_projections_corrected{n},footprints_projections_corrected{k});
