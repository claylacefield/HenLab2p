...
% Last Modified by GUIDE v2.5 11-Mar-2018 00:11:17
...
plot(handles.temporalAxes, handles.treadPos/50, 'c');
hold(handles.temporalAxes, 'on');
end
if handles.plotVel == 1
plot(handles.temporalAxes, handles.vel/500, 'g');
hold(handles.temporalAxes, 'on');
end
...
plot(handles.temporalAxes, handles.C(handles.segNum,:));
hold(handles.temporalAxes, 'off');
