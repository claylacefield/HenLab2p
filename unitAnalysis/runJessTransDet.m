function [jessTransStruc] = runJessTransDet(C, fps);
...
[zscored_cell,cell_transients,cell_events, cell_AUC]=detect_ca_transients(raw_cell,thresh,baseline,t_half,FR);
