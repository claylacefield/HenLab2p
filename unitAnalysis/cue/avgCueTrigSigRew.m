function avgCueTrigSigRew(segNum, eventName)
...
% rew times each lap
rew = treadBehStruc.rewZoneStartPos;
[counts, edges, rewPosBin] = histcounts(rew,10);
...
lapTypeArr(midRewInds) = 1;
lapTypeArr(notMidRewInds) = 2;
lapTypeArr(omitLaps) = 0;
