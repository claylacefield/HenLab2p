...
%                         
                        ...
                        for seg=1:length(midCueCellInd)
                            ...
                            try
                                ...
                                % concatenate lapCa for this cell
                                %try
...
try
figure; 
plotMeanSEMshaderr(cueShiftPairStruc.shiftLap,'r'); 
hold on; 
plotMeanSEMshaderr(cueShiftPairStruc.preLap,'g');
plotMeanSEMshaderr(cueShiftPairStruc.postLap,'b');
catch
end
