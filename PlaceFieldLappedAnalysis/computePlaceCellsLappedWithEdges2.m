function PCLappedSess = computePlaceCellsLappedWithEdges2(spikes, treadPos, T, shuffN)
...
PCSimple = computePlaceTransVectorLapCircShuffWithEdges4(spikes, treadPos, T, lapVec, shuffN, badPos);
